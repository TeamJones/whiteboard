...
describe "courses" do
  ...
  context 'As a Professor' do
    before do
      ...
      visit team_formation_tool_path(@course)
    end

    it 'says there are no teams to display when no teams are defined' do
      page.should have_content('There are no teams to display in the team formation tool')
    end
  end
end